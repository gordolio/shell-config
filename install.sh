...
fix_symlink "$HOME/.tigrc"                      "$SHELL_CONFIG/tigconfig/tigrc"        ".tigrc"
...
fix_symlink "$HOME/.codex/statusline.config.toml" "$SHELL_CONFIG/codex/statusline.config.toml" ".codex/statusline.config.toml"
